...
import android.hardware.Camera.MotionDetectCallback;
/**
...
class AndroidCameraManagerImpl implements CameraManager {
    ...
    private static final int SET_MOTION_DETECT_CALLBACK =     109;
    // Parameters
            ...
            try {
                switch (msg.what) {
                    ...
                    case SET_FACE_DETECTION_LISTENER:
                        ...
                        return;
                    case SET_MOTION_DETECT_CALLBACK:
                        mCamera.setMotionDetectCallback((MotionDetectCallback) msg.obj);
                        return;
    ...
    public class AndroidCameraProxyImpl implements CameraManager.CameraProxy {
        ...
        public void setMotionDetectCallback(MotionDetectCallback cb) {
                        mCameraHandler.obtainMessage(SET_MOTION_DETECT_CALLBACK, cb).sendToTarget();
                  }
        @Override
