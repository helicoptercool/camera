...
public class TouchlessA3D implements Closeable {
    ...
    private static native long cAlloc(TouchlessA3D thiz, int imageWidth, int imageHeight,
            int imageStep, int offset, Context applicationContext);
     ...
     *            {@link #handleImage(long, byte[])}.
     */
    public TouchlessA3D(int imageWidth, int imageHeight, Context applicationContext) throws LicenseNotValidException,
            LicenseServerUnavailableException {
        this(imageWidth, imageHeight, imageWidth, 0, applicationContext);
    }
     ...
     *            a positive integer.
     */
    public TouchlessA3D(int imageWidth, int imageHeight, int imageStep, Context applicationContext)
            throws LicenseNotValidException, LicenseServerUnavailableException {
        this(imageWidth, imageHeight, imageStep, 0, applicationContext);
    }
     ...
     *            the image from.
     */
    public TouchlessA3D(int imageWidth, int imageHeight, int imageStep, int offset, Context applicationContext)
            throws LicenseNotValidException, LicenseServerUnavailableException {
        mNativeObj = cAlloc(this, imageWidth, imageHeight, imageStep, offset, applicationContext);
    }
